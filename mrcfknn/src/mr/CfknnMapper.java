...
public class CfknnMapper extends Mapper<LongWritable, Text, NullWritable, Text> {
    ...
    protected void setup(Context context)
        ...
        //加载数据子集
        String path = context.getConfiguration().get("subSetPath", "");
